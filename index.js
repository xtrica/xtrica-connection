/*
 * xtrica-connection v1.0.1516817117 (https://xtrica.com)
...
if(vm.mutex===!1){try{let x=new XMLHttpRequest();x.open('HEAD','/?time='+(new Date()).getTime(),!0);x.onload=()=>{vm.status=parseInt(x.status)===200?!0:!1};x.send()}catch(error){console.log(error)}}else{vm.mutex=!1}},1100)}