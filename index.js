/*
 * xtrica-connection v1.0.1516820595 (https://xtrica.com)
...
if(vm.changed===!1){if(window.location.hostname!=='localhost'){if(vm.mutex===!1){vm.mutex=!0;try{let x=new XMLHttpRequest();x.open('HEAD','/?time='+(new Date()).getTime());let timeout=setTimeout(()=>{x.abort();vm.mutex=!1},2200);x.onreadystatechange=()=>{if(x.readyState===4){clearTimeout(timeout);vm.status=parseInt(x.status)===200?!0:!1;vm.mutex=!1}};x.send(null)}catch(error){vm.mutex=!1}}}}else{vm.changed=!1}},1100)}