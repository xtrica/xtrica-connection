/*
 * xtrica-connection v1.0.1516815680 (https://xtrica.com)
...
clearInterval(vm.interval);window.removeEventListener('online',vm.setStatusOnline);window.removeEventListener('offline',vm.setStatusOffline);window.navigator.removeEventListener('onLine',vm.setStatus)};window.navigator.addEventListener('onLine',this.setStatus);window.addEventListener('offline',this.setStatusOffline);window.addEventListener('online',this.setStatusOnline);this.interval=setInterval(()=>{let vm=this
